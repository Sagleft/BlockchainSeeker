...
namespace Bitnet.Client
{
  interface IBitnetClient
  {
    ...
    /// <summary>
    /// Returns the current bit-address for receiving payments to this account.
    /// </summary>
    ...
    /// unlock wallet.
    /// </summary>
    void WalletPassphrase(string password, int timeout);
    ...
    //getblockhash
    string GetBlockHash(int block_number);
    ...
    /// <summary>
    /// Returns a private key for given address.
    /// </summary>
    ...
    Dictionary<string, string> GetAccountsKeys();
